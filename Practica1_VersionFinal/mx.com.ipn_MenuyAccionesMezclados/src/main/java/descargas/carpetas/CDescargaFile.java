...
public class CDescargaFile {
    ...
    public void envioDeCliente() {
        ...
        try {
            ...
            cl = null;    // Se intentará conectar al servidor que está en el PUERTO 8009
            cl = this.conectaSocket();
            System.out.println("Conexion con servidor establecida, elija la carpeta a Descargar");
            JFileChooser jf = new JFileChooser(carpetaRaiz.getAbsolutePath()+"\\Nube");   // Creando mi instancia del FileChooser, por default podemos ELEGIR SÓLO UN ARCHIVO
...
//              Debido a que si mandamos archivos grandes, no tenemos tanta memoria 
                ...
                System.out.print("\rDescargado el " + porcentaje + " % del archivo");
            }//while
            System.out.println("\nArchivo enviado..");
            dis.close();
            dos.close();
    ...
    public Socket conectaSocket() throws IOException {
        ...
        int pto = 8009;
        String dir = "localhost";   // Podemos poner local HOST DIR==IP PUBLICA  
        Socket c = new Socket(dir, pto);    // Se intentará conectar al servidor que está en el PUERTO 8009
        return c;
    }
    ...
    public void seleccionarFilesADescargar() {
        ...
        try {
            int pto = 8009;
            String dir = "localhost";   // Podemos poner local HOST DIR==IP PUBLICA  
            Socket cl = null;    // Se intentará conectar al servidor que está en el PUERTO 8009
...
//            
    ...
    public void descargaArchivos() { //Se recibirán los archivos del servidor 
        try {
            ...
            Logger.getLogger(CDescargaFile.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//            nombre y tam deben estar en orden 
                String nombre = dis.readUTF(); // Esto está conectado con el Flujo de Salida dos, del archivo CDescargaFile.java
