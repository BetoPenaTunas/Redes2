...
import descargas.ClieDescargas;
import descargas.carpetas.SDescargaFile;
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        while (choice != 7) {
            ...
            if (choice == 1) {
                ...
                ClieDescargas clie = new ClieDescargas();
                clie.recibeServidor();
                clie.cl.close();
                s.cl.close();
                ClieDescargas.s.close();

            } else if (choice == 6) {
                SDescargaFile s6 = new SDescargaFile();
                s6.recibeServidor();  //recibiendo carpetas 
                s.cl.close();
                SDescargaFile.s.close();
            } else {
                s.s.close();
                s.cl.close();
            }
