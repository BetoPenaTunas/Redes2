...
public class ClieDescargas {
    public static ServerSocket s;
    public  Socket cl;
    public void recibeServidor(){
      try{
          int pto = 8007;   // App corriendo en este puerto
          ...
          System.out.println("Servidor iniciado esperando solicitud de descarga...");
...
//                No importa si mis paquetes se DESORDENAN ya que TCP los ordena
    ...
    public String creaDirectorio(){
         ...
         // ----> CREANDO UNA CARPETA EN DONDE SE GUARDARÁN LOS ARCHIVOS <-----
          ...
          String carpeta="Descargas";    // Concatenaremos esta nombre a la ruta 
