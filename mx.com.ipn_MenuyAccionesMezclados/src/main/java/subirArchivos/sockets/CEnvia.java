...
public class CEnvia {
    public void envioDeCliente(){
        try{
            ...
            Socket cl = null;    // Se intentará conectar al servidor que está en el PUERTO 8001
...
//              Debido a que si mandamos archivos grandes, no tenemos tanta memoria 
    ...
    public Socket conectaSocket() throws IOException{
            ...
            int pto = 8001;
            String dir = "localhost";   // Podemos poner local HOST DIR==IP PUBLICA  
            Socket c = new Socket(dir,pto);    // Se intentará conectar al servidor que está en el PUERTO 8001
            return c;
    }
